...
export const ProviderSchema = z.discriminatedUnion("name", [
  z.object({
    name: z.literal("gaia"),
    envvar: z.literal("GAIA_API_KEY"),
    model: z.enum(["llama", "llama3b", "qwen7b", "qwen72b"]).default("llama"),
    baseUrl: z
      .enum([
  ...
  z.object({
    ...
    envvar: z.literal("HYPERBOLIC_API_KEY"),
    model: z
      .enum([
  ...
  z.object({
    ...
    envvar: z.literal("OPENAI_API_KEY"),
    model: z
      .enum([
        "gpt-4o",
        "gpt-4o-mini",
    ...
    embedding: z
      .enum([
        "text-embedding-3-big",
        "text-embedding-3-small",
        "text-embedding-ada-002",
      ])
      .default("text-embedding-3-big"),
  }),
]);
